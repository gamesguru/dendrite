...
func UnmarshalJSONRequest(req *http.Request, iface any) *util.JSONResponse {
...
func UnmarshalJSON(body []byte, iface any) *util.JSONResponse {
	if !utf8.Valid(body) {
		return &util.JSONResponse{
...
//   - M_FORBIDDEN, M_UNABLE_TO_AUTHORIZE_JOIN -> 403
