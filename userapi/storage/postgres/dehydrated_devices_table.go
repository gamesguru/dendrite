...
const insertDehydratedDeviceSQL = "" +
	"INSERT INTO userapi_dehydrated_devices (user_id, device_id, device_data, created_ts) VALUES ($1, $2, $3, $4)" +
	" ON CONFLICT (user_id) DO UPDATE SET device_id = $2, device_data = $3, created_ts = $4"
...
func NewPostgresDehydratedDevicesTable(db *sql.DB) (tables.DehydratedDevicesTable, error) {
