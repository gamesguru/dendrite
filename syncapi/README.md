...
- For very large state deltas, the `state` section of a room is correctly populated with the state of the room at the _start_ of the timeline.
...
- Work out _which_ rooms to return to the client.
- For each room, work out _which_ events to return to the client.
